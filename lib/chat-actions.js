const ACTION_TYPES={ASSESS_PRE_HK:'assess_pre_hk',ASSESS_IN_HK:'assess_in_hk',ASSESS_CROSS_BORDER:'assess_cross_border',ACCOUNT_SYNC_REQUIRED:'account_sync_required'};
const ACTION_MARKER=/\[\[\s*HKP_ACTION(?:_V1)?\s*:\s*(ASSESS_PRE_HK|ASSESS_IN_HK|ASSESS_CROSS_BORDER|ACCOUNT_SYNC_REQUIRED)\s*\]\]/gi;
...
export function persistableAgentReply(reply,action){
 const marker={assess_pre_hk:'[[HKP_ACTION_V1:ASSESS_PRE_HK]]',assess_in_hk:'[[HKP_ACTION_V1:ASSESS_IN_HK]]',assess_cross_border:'[[HKP_ACTION_V1:ASSESS_CROSS_BORDER]]',account_sync_required:'[[HKP_ACTION_V1:ACCOUNT_SYNC_REQUIRED]]'}[action?.type];
